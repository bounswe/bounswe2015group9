...
function MainCtrl($scope,$http) {
    ...
    $scope.register=function(){
    	$http({
	  method: 'POST',
	  url: 'ec2-54-69-10-151.us-west-2.compute.amazonaws.com:8080/universal-access/oauth/token?grant_type=client_credentials' ,
	...
	$http({
	  method: 'POST',
	  url: 'ec2-54-69-10-151.us-west-2.compute.amazonaws.com:8080/universal-access/rest/users' ,
